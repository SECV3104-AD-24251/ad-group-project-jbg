                    ...
                    <div class="formcontainer">
                        <form action="{{ route('updatecourse') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <input type="text" value="{{ $data->name }}" name="name" id="form4Example1"
                                    class="form-control" />
                            </div>
                            {{-- image input --}}
                            <div class="form-outline mb-1">
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <input type="text" value="{{ $data->link }}" name="link" id="form4Example2"
                                    class="form-control" />
                            </div>
                            <div class="form-outline mb-1">
                                <label class="form-label" for="form4Example2">Level</label>
                                <input type="text" name="level" value="{{ $data->level }}" id="form4Example2"
                                    class="form-control" />
                            </div>
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <textarea name="description" class="form-control" id="form4Example3" rows="12">{{ $data->description }}</textarea>
                            </div>
