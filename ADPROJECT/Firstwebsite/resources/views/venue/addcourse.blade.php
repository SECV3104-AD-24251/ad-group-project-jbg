                    ...
                    <div class="formcontainer">
                        <form action="{{ route('storecourse') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <input type="text" name="level" id="form4Example2" class="form-control"
                                    placeholder="Hard / Easy" />
                            </div>

                            <!-- Message input -->
                            <div class="form-outline mb-1">
                                <label class="form-label" for="form4Example3">Description</label>
                                <textarea name="description" class="form-control" placeholder="Description example ,you can add up to 500 word here"
                                    id="form4Example3" rows="12"></textarea>
                            </div>
