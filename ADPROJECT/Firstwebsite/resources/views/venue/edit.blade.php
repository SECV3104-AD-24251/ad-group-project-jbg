...
<body style="background-color: #efefef;">
    ...
    @include('comp.venuenav')
    @include('comp.venuesidbar')
    {{-- if success --}}
    @if (session('success'))
        {{-- sweet alert --}}
            ...
            <div class="row mb-4">
                ...
                <div class="row bg-white ms-2 mt-4">
                    ...
                    <div class="p-3 py-5">
                        ...
                        <form method="post" action="{{ route('updatevenue') }}" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                            <div class="row mt-2">
                                <div class="col-md-12 mb-1"><label class="labels">Full name</label><input
                                        value="{{ $data->name }}" type="text" name="name" class="form-control"
                                        placeholder="Enter your name"></div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels">Avatar </label><input type="file"
                                        name="image" class="form-control"></div>

                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12"><label class="labels">price </label><input type="number"
                                        value="{{ $data->price }}" name="price" class="form-control"
                                        placeholder="400dh"></div>

                            </div>
                            <div class="row mt-3">
                                <div class="col-md-12 mb-1"><label class="labels">Years of experience</label><input
                                        value="{{ $data->yearsofexperience }}" name="yearsofexperience" type="number"
                                        class="form-control" placeholder="4 years "></div>
                            </div>
                            <div class="row mt-3">

                                <div class="col-md-12"><label class="labels">Address Line </label><input type="text"
                                        value="{{ $data->location }}" name="location" class="form-control"
                                ...
                                <div class="col-md-12 border-right">
                                    <form action="{{ route('updatePassword') }}" method="post">
                                        ...
                                        <div class="p-3 py-5">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6"><label class="labels">Old password</label><input
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6"><label class="labels">Repeat
                                                        password</label><input name="repeatpassword" type="password"
                                    ...
                                    <div class="mt-2">
                                        <form action="{{ route('profile.destroy') }}" method="post" id="deleteacc">
                                            @method('DELETE')
                                            @csrf
                                            <div class=""><button class="btn btn-danger profile-button w-100"
                                                    type="button" onclick="alerting()">DELETE ACCOUNT</button></div>
                                        </form>
