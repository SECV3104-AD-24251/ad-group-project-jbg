        ...
        <div class="container mt-5  ">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    {{-- <h1>Welcome to Your venueing Dashboard</h1>

                <p>From here, you can manage your venueing schedule, review your progress, and book new venueing sessions or online courses. Use the menu on the left to access different parts of your dashboard, or click on the quick links to jump to specific actions. We hope you find our platform helpful in achieving your sports goals, and we look forward to seeing your progress!</p> --}}
                </div>
            ...
            @endif
            @if (session('success'))
                <div class="mt-3 alert alert-success"><i class="bi bi-check-circle-fill"></i> {{ session('success') }}
                </div>
            @endif
            @if (session('error'))
                            ...
                            <div class="col-md-12 border-right">
                                <div class="p-3 py-5">
                                    ...
                                    <form method="post" action="{{ route('profile.update') }}"
                                        ...
                                        @method('patch')
                                        <div class="row mt-2">
                                            <div class="col-md-12 mb-1"><label class="labels">Full name</label><input
                                                    type="text" name="name" class="form-control"
                                                    placeholder="enter phone number" value="{{ $user->name }}"></div>
                                        </div>
                                        <div class="row mt-2">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12 mb-1"><label class="labels">Mobile
                                                    Number</label><input name="phone" type="text"
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-12"><label class="labels">Address Line </label><input
                                                    type="text" name="adress" class="form-control"
                                                    placeholder="enter address line 1" value="{{ $user->adress }}">
                                            </div>
                                        </div>

                                        <div class="row mt-3">
                                            <div class="col-md-12"><label class="labels">Avatar </label><input
                                                    type="file" name="image" class="form-control"></div>

                                        </div>

                                        <div class="mt-4 "><button class="btn btn-outline-success profile-button"
                                                type="submite">Save
                                                Profile</button></div>
                                </div>
                                </form>
                                            ...
                                            <div class="col-md-12 border-right">
                                                <form action="{{ route('updatePassword') }}" method="post">
                                                    ...
                                                    <div class="p-3 py-5">
                                                        ...
                                                        <div class="row mt-3">
                                                            <div class="col-md-6"><label class="labels">Old
                                                                    password</label><input name="oldpassword"
                                                                    type="password" class="form-control"
                                                                    placeholder="********" value=""></div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-6"><label class="labels">New
                                                                    password</label><input name="newpassword"
                                                                    type="password" class="form-control"
                                                                    placeholder="********" value=""></div>
                                                        </div>
                                                        <div class="row mt-3">
                                                            <div class="col-md-6"><label class="labels">Repeat
                                                                    password</label><input name="repeatpassword"
                                                                    type="password" class="form-control"
                                                                    placeholder="*********" value=""></div>
                                                        </div>
                                                ...
                                                <div class="mt-2">
                                                    <form action="{{ route('profile.destroy') }}" method="post"
                                                        ...
                                                        @csrf
                                                        <div class=""><button
                                                                class="btn btn-danger profile-button w-100"
                                                                type="button" onclick="alerting()">DELETE
                                                                ACCOUNT</button></div>
                                                    </form>
          ...
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">I am a female venue with 4 years of experience , i love Baskete-ball <3 </p>
            </div>
            <div class="card-footer">
              <small class="text-muted"><i class="bi bi-check-all"></i> Online</small>
                                            ...
                                            {{-- <div class="col">
          <div class="card h-100">
            <img src="https://media.stack.com/stack-content/uploads/2020/02/11185812/venue-Communication.jpg" class="card-img-top" alt="Palm Springs Road"/>
            <div class="card-body">
              <h5 class="card-title">Ahmad Yassin CHAFII</h5>
              <p class="card-text">
            I am a Foot-ball player & venue , i have 5 years of experience in the field of venueing.
              </p>
            </div> --}}
