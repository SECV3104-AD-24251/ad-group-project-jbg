        ...
        <div class="container mt-5  ">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1>Welcome to Isport - No pain no gain !</h1>

                    <p>From here, you can manage your venueing schedule, review your progress, and book new venueing
                        sessions or
                        online courses. Use the menu on the left to access different parts of your dashboard, or click
                        on the quick
                        links to jump to specific actions. We hope you find our platform helpful in achieving your
                        sports goals, and
            ...
            <div class="row mb-4">
                ...
                <div class="col-12">
                    <h1 class="text-dark">Top venuees <i class="bi bi-chat-square-heart"></i></i></h1>
                    <div class="mt-4">
                        <div class="row row-cols-1 row-cols-md-3 g-4">
                            @foreach ($venuees as $item)
                                <div class="col">
                                    <div class="card h-100">
                                        ...
                                        <div class="card-footer d-flex">
                                            ...
                                            <a href="/dashboard/venue/{{ $item->id }}"
                                                class="btn btn-success btn-sm ms-auto"><i
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-footer d-flex">
                                        ...
                                        <a href="{{ route('viewCourse', $item->id) }}"
                                            class="btn btn-success btn-sm ms-auto"><i class="bi bi-play-circle"></i>
                                            View Course</a>
