                    ...
                    <form id="quiz-form">
                        ...
                        <div class="form-group ">
                            ...
                            <select class="w-100" id="activity-level" name="activity-level" required>
                                ...
                                <option value="moderately-active">Moderately active (moderate exercise or sports 3-5
                                    days a week)
                                </option>
                                <option value="very-active">Very active (hard exercise or sports 6-7 days a week)
                                </option>
