        ...
        <div class="row mb-4">
            ...
            <div class="mt-2">
                <div id="quiz" class="w-50" style="background-color: #243441; border:none;">
                    <h2 class="text-success">Getting to know you</h2>
                    <form id="quiz-form">
                        <div class="form-group">
                            <label class="text-white" for="preference">What is your preference venue?</label>
                            <input type="text" id="preference" name="preference" class="w-100" required>
                        </div>
                        <div class="form-group">
                            <label class="text-white" for="role">Are you a student, lecturer or staff?</label>
                            <div>
                                <input type="text" id="role" name="role" class="w-100" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="text-white" for="course">What is your course?</label>
                            <select class="w-100" id="course" name="course" required>
