...
<head>
    ...
    <title>ISPORT - Apply for venueing</title>
    ...
    @if (count($data) > 1)
        ...
        <script>
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'you have already apply for venueing',
            })
        </script>
    @endif
    ...
    @if (session('success'))
        ...
        <script>
            ...
            Swal.fire({
                icon: 'success',
                title: 'Good job!',
                text: 'you have apply for venueing',
            })
        </script>
    @endif
    {{-- if success a sweat alert --}}
    ...
    <div id="page-content-wrapper">
        <div class="container mt-5  ">
            ...
            <div class="row mb-4">
                ...
                @if (count($data) > 0)
                    <div class="col-md-12">
                        <h1 class="text-success">Your venueing Application</h1>
                        <p class="text-dark">You have already applied for venueing. We will contact you soon.</p>
                    </div>
                    <div class="imageGif">
                        ...
                        <div class="firstSection" id="home">
                            <div class="container ">
                                <div class="row align-items-center">
                                    <div class="col-md-6">
                                        <img src="../images/—Pngtree—fitness venue_488811.png" alt=""
                                            class="img-fluid ">
                                    </div>
                                    <div class="col-md-6 ">
                                        <h2 class="text-success ">Do you wanna be venue ? </h2>
                                        <p class="text-dark">Being a venue in sports is a fulfilling and rewarding
                                            profession that involves
                                            working with athletes to help them achieve their full potential. As a venue,
                                            you play a critical
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('applyvenueing') }}" method="post">
                        @csrf
                        <label for="sport">
