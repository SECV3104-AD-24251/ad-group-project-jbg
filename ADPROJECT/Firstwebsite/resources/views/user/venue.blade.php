...
<body style="background-color: #efefef;">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                ...
                                <p class="card-text"><small class="text-muted"></small>{{ $data->price }} DH / PAR 1H
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="p-3" style="background: white;">
            <form method="POST" action="{{ route('booking') }}">
                ...
                <div class="form-group">
                    <input type="hidden" name="venue_id" id="name" class="form-control"
                        value="{{ $data->id }}" required>

                </div>
                <div class="form-group">
                    <input type="hidden" name="sport" id="name" class="form-control" value="{{ $data->sport }}"
                        required>
                ...
                <div class="form-group">
                    ...
                    <input type="time" name="time" id="time"
                        class="form-control @error('time') is-invalid @enderror" value="{{ old('time') }}" required>
                    @error('time')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    <div>
        ...
        <a target="_blank" href="https://api.whatsapp.com/send?phone={{ $venueuser->phone }}">
