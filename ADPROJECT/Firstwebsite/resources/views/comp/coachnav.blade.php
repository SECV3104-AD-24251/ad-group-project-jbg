<nav class="navbar navbar-expand-lg bg-body-tertiar border-bottom-0 position-fixed top-0 w-100"
    ...
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="{{ route('home') }}"><i class="text-success bi bi-play "></i>Venue System
        </a>
            ...
            <div>
                @if (Auth::check())
                    <form method="POST" action="{{ Route('logout') }}">
                        @csrf
                        <a type="button" class="btn btn-success nav-item btn-sm "
                ...
                @else
                    ...
                    <a type="button" class="btn btn-outline-success btn-sm nav-item "
