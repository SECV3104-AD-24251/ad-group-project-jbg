<nav class="navbar navbar-expand-lg bg-body-tertiar border-bottom-0 position-fixed top-0 w-100"
    ...
    <div class="container-fluid">
        <a class="navbar-brand text-white" href="{{ route('home') }}"><i class="text-success bi bi-play "></i> Venue </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{ route('searchCoaches') }}">Venues</a>
                </li>
                <!--<li class="nav-item">
